# LED Display Build System

Build system documentation for the led_display firmware.
...
**Use pioarduino fork, NOT official PlatformIO**
...
**Note:** FastLED is used for color math and effects; NeoPixelBus handles only the final SPI data transfer.
