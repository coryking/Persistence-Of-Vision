...
Command remoteInputPoll() {
    ...
    switch (code) {
        ...
        case SAGETV_BTN_CH_UP: cmd = Command::NextEffect; break;
        case SAGETV_BTN_CH_DOWN: cmd = Command::PrevEffect; break;
        ...
        case SAGETV_BTN_DELETE: cmd = Command::CaptureDelete; break;
        case SAGETV_BTN_INFO: cmd = Command::StatsToggle; break;
        default:
